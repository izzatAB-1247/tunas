...
<div class="container py-4">
   <div class="row align-items-center mb-4">
    <div class="col-md-12"> <h2 class="fw-bold text-dark"><i class="bi bi-briefcase-fill text-primary"></i> Pelatihan Persiapan Kerja</h2>
        <p class="text-muted">Halo! Pilih materi di bawah ini untuk mulai meningkatkan keahlian profesionalmu.</p>
    </div>
    </div>
